            ...
            <div className="header-top">
              <div className="header-top__container wrapper">
                ...
                <div className="header-top__info">
                  ...
                  <Link to="javascript:void(0)" className="header-top__email">
                    ...
                    <div className='header-top__email-text'>sale@deti.moda</div>
                  </Link>
                </div>

                <div className="header-top__gestion">
                  <div className="header-top__gestion-item gestion">
                    <div className="header-top__gestion-icon">
                  ...
                  <div className="header-top__gestion-item gestion">
                    ...
                    <div className="header-top__gestion-quantity">38</div>
                  </div>
                  <div className="header-top__gestion-item gestion">
                    <div className="header-top__gestion-icon">
                    ...
                    <div className="header-top__gestion-quantity">3</div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="header-center__right">
                    ...
                    <div className="header-center__infos">
                      ...
                      <button className="button">
                        <div className="button__text">Обратный звонок</div>
                      </button>
                    </div>
                  </div>
